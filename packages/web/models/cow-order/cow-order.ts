...
export const COW_API_URL: Readonly<Record<ChainId, string>> = {
  ...
  // [ChainId.POLYGON]: `${COW_API_BASE_URL}/polygon/${API_VERSION_PATH}`,
  // [ChainId.AVALANCHE]: `${COW_API_BASE_URL}/avalanche/${API_VERSION_PATH}`
}
...
export const COW_API_EXPLORER_URL: Readonly<Record<ChainId, string>> = {
  ...
  // [ChainId.AVALANCHE]: `${COW_EXPLORER_BASE_URL}/avax/${ORDERS_PATH}/`
}
