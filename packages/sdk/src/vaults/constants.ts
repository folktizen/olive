...
const POLYGON_SUBGRAPH_ENDPOINT_URL =
  ...
  `${ALCHEMY_API_BASE_URL}/${ALCHEMY_PROJECT_ID}/funtend--3839364/olv-on-polygon/version/v1.5.0-blankon/api`
const AVALANCHE_SUBGRAPH_ENDPOINT_URL =
  process.env.AVALANCHE_SUBGRAPH_API_URL ??
  `${ALCHEMY_API_BASE_URL}/${ALCHEMY_PROJECT_ID}/funtend--3839364/olv-on-avalanche/version/v1.5.0-blankon/api`
