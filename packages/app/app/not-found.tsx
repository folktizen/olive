    ...
    <Suspense fallback={null}>
      <div className="flex flex-col items-center justify-center max-w-xl mx-auto my-32 space-y-7">
        ...
        <HeadingText className="text-center text-em-med">
          {`We're sorry, but the page you are looking for cannot be found. Please check the URL and try again. If you believe this is an error, please contact us on our `}
          <Link
            href={discordLink}
